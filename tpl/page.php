	...
	<div id="poststuff">
		...
		<form action="<?php echo esc_url( $form_save_url ) ?>" method="POST" id="so-custom-css-form">
			...
			<div class="custom-css-toolbar">
				...
				<div class="toolbar-action-buttons">
					<span class="save socss-button button-primary" title="<?php echo __( 'Save CSS', 'so-css' ); ?>">
						<span class="so-css-icon so-css-icon-save"></span>
					</span>

					<a href="#visual" class="editor-visual socss-button" title="<?php echo __( 'Open Visual Mode', 'so-css' ); ?>">
						<span class="so-css-icon so-css-icon-eye"></span>
					</a>

					<a href="#expand" class="editor-expand socss-button">
						<span class="so-css-icon so-css-icon-expand" title="<?php echo __( 'Open Expanded Mode', 'so-css' ); ?>"></span>
						<span class="so-css-icon so-css-icon-compress" title="<?php echo __( 'Close Expanded Mode', 'so-css' ); ?>"></span>
					</a>
				</div>
			</div>
		...
		<div id="so-custom-css-properties">
			...
			<div class="toolbar">
				...
				<div class="close socss-button" title="<?php echo __( 'Close', 'so-css' ); ?>">
					<span class="so-css-icon so-css-icon-check"></span>
				</div>
				<div class="save socss-button button-primary" title="<?php echo __( 'Save CSS', 'so-css' ); ?>">
					<span class="so-css-icon so-css-icon-save"></span>
				</div>
			</div>
